 ...
 *   <li>{@link org.hl7.fhir.CodeSystemDesignation#getAdditionalUse <em>Additional Use</em>}</li>
...
public interface CodeSystemDesignation extends BackboneElement {
	 ...
	 * @see org.hl7.fhir.FhirPackage#getCodeSystemDesignation_AdditionalUse()
	 * @model containment="true"
