...
public interface ConceptMap extends MetadataResource {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Indicates the mechanism used to compare versions to determine which ConceptMap is more current. (choose any one of versionAlgorithm*, but only one)
	 * <!-- end-model-doc -->
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Identifier for the source value set that contains the concepts that are being mapped and provides context for the mappings.  Limits the scope of the map to source codes (ConceptMap.group.element code or valueSet) that are members of this value set. (choose any one of sourceScope*, but only one)
	 * <!-- end-model-doc -->
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Identifier for the target value set that provides important context about how the mapping choices are made.  Limits the scope of the map to target codes (ConceptMap.group.element.target code or valueSet) that are members of this value set. (choose any one of targetScope*, but only one)
	 * <!-- end-model-doc -->
